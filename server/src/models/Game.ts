...
import {JUDGE, JUDGE_SELECTING, JUDGE_WAITING, PLAYER, PLAYER_SELECTING, PLAYER_WAITING} from '@/constants';
...
class Game implements GameInterface {
    ...
    getPlayerRoundState(sessionID: string) {
        let player = this.getPlayer(sessionID);
        ...
        if (latestRound?.roundState === JUDGE_SELECTING || latestRound?.roundState === 'viewing-winner') {
            timeLeft = 0;
